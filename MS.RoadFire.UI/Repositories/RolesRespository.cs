...
//        {
//            return await _repository.GetAsync<List<RoleDto>>("api/Roles/GetAll");
//        }

//        public async Task<HttpResponseWrapper<ResponseDto<RoleDto>>> GetByIdAsync(int id)
//        {
//            return await _repository.GetAsync<RoleDto>($"api/Roles/Get/id?id={id}");
//        }
...
//        public async Task<HttpResponseWrapper<object>> DeleteAsync<T>(int id)
//        {
//            return await _repository.DeleteAsync($"api/Roles/Delete/id?id={id}");
//        }
//    }
//}